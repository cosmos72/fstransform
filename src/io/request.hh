...
#ifndef FSTRANSFORM_IO_REQUEST_HH
#define FSTRANSFORM_IO_REQUEST_HH
...
public:
    ...
    ft_request(ft_uoff from, ft_uoff to, ft_uoff length, ft_dir dir);
    ...
    FT_INLINE ft_dir  dir()    const { return this_dir;    }
     ...
     * returns EOVERFLOW if max(from,to)+length overflows ft_uoff
      */
    int assign(ft_uoff from, ft_uoff to, ft_uoff length, ft_dir dir);
     ...
     */
    int coalesce(ft_uoff from, ft_uoff to, ft_uoff length, ft_dir dir);
...
#endif /* FSTRANSFORM_IO_REQUEST_HH */
